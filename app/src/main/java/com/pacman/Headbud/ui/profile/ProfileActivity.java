package com.pacman.Headbud.ui.profile;
...
import com.pacman.Headbud.ui.login.LoginActivity;
                    ...
                    //            if (!gender.getText().toString().isEmpty()) {
                     //               myDatabase.collection("users").document(uid).update("Gender", gender.getText().toString());
                       //         }
                        ...
                        .setPositiveButtonIcon(AppCompatResources.getDrawable(ProfileActivity.this, R.drawable.correct))
                        .create();
                dialog.show();
